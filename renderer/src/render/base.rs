...
use vulkano::swapchain::{self, Surface, Swapchain, SwapchainAcquireFuture, SwapchainCreationError};
use vulkano::Version;
...
impl VulkanBase {
    ...
    pub fn acquire_next_swapchain_image(&mut self) -> Option<(usize, SwapchainAcquireFuture<Window>)> {
    ...
    pub fn resize_setup(&mut self) {
        ...
        let (swapchain, swapchain_images) =
            match self.swapchain.recreate().dimensions(self.dimensions).build() {
                Ok(r) => r,
